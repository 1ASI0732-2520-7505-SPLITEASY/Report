...
| Versión | Fecha      | Autor(es)                           | Descripción                                                                                                                                                                                      |
| ------- | ---------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **TP1** | 28/09/2025 | **Diego Fernando Herrera Enriquez** | Desarrollo del **Capítulo 5: Product Implementation & Deployment**, que incluye la planificación de **Sprint Backlogs** y la estructura de implementación general del producto.                  |
| **TP1** | 29/09/2025 | **Diego Fernando Herrera Enriquez** | Continuación del **Capítulo 5**, incluyendo la **Implemented Landing Page Evidence** y la documentación inicial de la implementación de la landing page.                                         |
| **TP1** | 30/09/2025 | **Eslander Celis Berrospi**         | **Capítulo 5** - Desarrollo de la **Implemented Frontend-Web Application Evidence**, pruebas iniciales y documentación sobre la integración del frontend con la landing page.                    |
| **TP1** | 01/10/2025 | **Eslander Celis Berrospi**         | Continuación del **Capítulo 5**, trabajo sobre el **Acuerdo de Servicio - SaaS** y detalles sobre el modelo de servicio propuesto para la plataforma.                                            |
| **TP1** | 02/10/2025 | **Rodrigo Alya Cabrera**            | Desarrollo de la **Implemented Native-Mobile Application Evidence** y revisión del diseño móvil, asegurando la coherencia con la web.                                                            |
| **TP1** | 03/10/2025 | **Rodrigo Alya Cabrera**            | **Capítulo 5** - Implementación del **RESTful API and/or Serverless Backend Evidence**, documentación técnica y configuración de la infraestructura del backend.                                 |
| **TP1** | 04/10/2025 | **Valentino Sandoval Paiva**        | Desarrollo de la **RESTful API documentation** para la integración y consumo de los endpoints del sistema.                                                                                       |
| **TP1** | 05/10/2025 | **Valentino Sandoval Paiva**        | **Capítulo 5** - **Team Collaboration Insights**, análisis y documentación sobre la colaboración entre miembros del equipo y su impacto en el desarrollo de la plataforma.                       |
| **TP1** | 06/10/2025 | **Valentino Sandoval Paiva**        | Desarrollo del **Capítulo 6: Product Verification & Validation**, que incluye **Core Entities Unit Tests** y **Core Integration Tests**. Enfoque en pruebas unitarias e integración del sistema. |
| **TP1** | 07/10/2025 | **Valentino Sandoval Paiva**        | Continuación del **Capítulo 6**, trabajo en **Core Behavior-Driven Development** y **Core System Tests**, validando la funcionalidad y comportamiento del producto.                              |
| **TP1** | 08/10/2025 | **Diego Fernando Herrera Enriquez** | Desarrollo del **Capítulo 7: DevOps Practices**, que incluye la implementación de herramientas y prácticas de **Continuous Integration**, y la construcción de la suite de pruebas.              |
| **TP1** | 09/10/2025 | **Diego Fernando Herrera Enriquez** | Continuación del **Capítulo 7**, trabajo en **Continuous Delivery**, implementación de herramientas y fases de despliegue del pipeline.                                                          |
| **TP1** | 10/10/2025 | **Eslander Celis Berrospi**         | Desarrollo del **Capítulo 7**, implementación de prácticas de **Continuous Deployment** y documentación de los componentes del pipeline para el despliegue en producción.                        |
| **TP1** | 11/10/2025 | **Eslander Celis Berrospi**         | Continuación del **Capítulo 7**, análisis y pruebas de **Production Deployment Pipeline Components**, validación del flujo de despliegue a producción.                                           |


| Versión | Fecha      | Autor(es)                           | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| :-----: | :--------- | :---------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **TB2** | 08/11/2025 | **Diego Fernando Herrera Enriquez** | **Desarrollo del Capítulo VI: Product Verification & Validation**<br>6.1. Testing Suites & Validation.<br>6.1.1. Core Entities Unit Tests.<br>6.1.2. Core Integration Tests.<br>6.1.3. Core Behavior-Driven Development.<br>6.1.4. Core System Tests.<br>6.2. Static Testing & Verification.<br>6.2.1. Static Code Analysis.<br>6.2.1.1. Coding Standard & Code Conventions.<br>6.2.1.2. Code Quality & Code Security.<br>6.2.2. Reviews.<br>6.3. Validation Interviews.<br>6.3.1. Diseño de Entrevistas.                                                                                                                                                                                                                                                                                                |
| **TB2** | 08/11/2025 | **Eslander Celis Berrospi**         | **Desarrollo del Capítulo VI: Product Verification & Validation**<br>6.3.2. Registro de Entrevistas.<br>6.3.3. Evaluaciones según heurísticas.<br>6.4. Auditoría de Experiencias de Usuario.<br>6.4.1. Auditoría realizada.<br>6.4.1.1. Información del grupo auditado.<br>6.4.1.2. Cronograma de auditoría realizada.<br>6.4.1.3. Contenido de auditoría realizada.<br>6.4.2. Auditoría recibida.<br>6.4.2.1. Información del grupo auditor.<br>6.4.2.2. Cronograma de auditoría recibida.<br>6.4.2.3. Contenido de auditoría recibida.<br>6.4.2.4. Resumen de modificaciones para subsanar hallazgos.                                                                                                                                                                                                  |
| **TB2** | 08/11/2025 | **Rodrigo Alya Cabrera**            | **Desarrollo del Capítulo VII: DevOps Practices**<br>7.1. Continuous Integration.<br>7.1.1. Tools and Practices.<br>7.1.2. Build & Test Suite Pipeline Components.<br>7.2. Continuous Delivery.<br>7.2.1. Tools and Practices.<br>7.2.2. Stages Deployment Pipeline Components.<br>7.3. Continuous Deployment.<br>7.3.1. Tools and Practices.<br>7.3.2. Production Deployment Pipeline Components.<br>7.4. Continuous Monitoring.<br>7.4.1. Tools and Practices.<br>7.4.2. Monitoring Pipeline Components.                                                                                                                                                                                                                                                                                               |
| **TB2** | 08/11/2025 | **Valentino Sandoval Paiva**        | **Desarrollo del Capítulo VII y VIII: DevOps Practices & Experiment-Driven Development**<br>7.4.3. Alerting Pipeline Components.<br>7.4.4. Notification Pipeline Components.<br>8.1. Experiment Planning.<br>8.1.1. As-Is Summary.<br>8.1.2. Raw Material: Assumptions, Knowledge Gaps, Ideas, Claims.<br>8.1.3. Experiment-Ready Questions.<br>8.1.4. Question Backlog.<br>8.1.5. Experiment Cards.<br>8.2. Experiment Design.<br>8.2.1. Hypotheses.<br>8.2.2. Domain Business Metrics.<br>8.2.3. Measures.<br>8.2.4. Conditions.<br>8.2.5. Scale Calculations and Decisions.<br>8.2.6. Methods Selection.<br>8.2.7. Data Analytics: Goals, KPIs and Metrics Selection.<br>8.2.8. Web and Mobile Tracking Plan.<br>8.3. Experimentation.<br>8.3.1. To-Be User Stories.<br>8.3.2. To-Be Product Backlog. |

| Versión | Fecha      | Autor(es)                           | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                  |
| :-----: | :--------- | :---------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **TF** | 08/11/2025 | **Diego Fernando Herrera Enriquez** | • 8.3.4. To-Be Validation Interviews (colaboración conjunto al equipo).<br>• 8.3.4.1. Diseño de Entrevistas (trabajo conjunto).<br>• 8.3.4.2. Registro de Entrevistas (trabajo conjunto).<br>• 8.5. Continuous Learning.<br>• 8.5.1. Shareback Session Artifacts: Learning Workflow.<br>• 8.3.3.5. Implemented To-Be RESTful API and/or Serverless Backend Evidence.                        |
| **TF** | 08/11/2025 | **Eslander Celis Berrospi**         | • 8.3.4. To-Be Validation Interviews (trabajo conjunto).<br>• 8.3.4.1. Diseño de Entrevistas (trabajo conjunto).<br>• 8.3.4.2. Registro de Entrevistas (trabajo conjunto).<br>• 8.4. Experiment Aftermath & Analysis.<br>• 8.4.1. Analysis and Interpretation of Results.<br>• 8.4.2. Re-scored and Re-prioritized Question Backlog.<br>• 8.3.3.2. Implemented To-Be Landing Page Evidence. |
| **TF** | 08/11/2025 | **Rodrigo Alya Cabrera**            | • 8.3.4. To-Be Validation Interviews (trabajo conjunto).<br>• 8.3.4.1. Diseño de Entrevistas (trabajo conjunto).<br>• 8.3.4.2. Registro de Entrevistas (trabajo conjunto).<br>• 8.6. To-Be Software Platform Pre-launch.<br>• 8.6.1. About-the-Product Intro Video.<br>• 8.3.3.4. Implemented To-Be Native-Mobile Application Evidence.                                                     |
| **TF** | 08/11/2025 | **Valentino Sandoval Paiva**        | • 8.3.3.1. To-Be Sprint Backlogs.<br>• 8.3.3.3. Implemented To-Be Frontend-Web Application Evidence.<br>• 8.3.4. To-Be Validation Interviews (trabajo conjunto).<br>• 8.3.4.1. Diseño de Entrevistas (trabajo conjunto).<br>• 8.3.4.2. Registro de Entrevistas (trabajo conjunto).<br>• 8.3.3.6. Team Collaboration Insights.                                                               |




Link del repositorio: https://github.com/1ASI0732-2520-7505-SPLITEASY/Report/tree/develop
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software**                                                                  | TB1: <br> **Rodrigo Alya Cabrera :**<br>Desarrolló la arquitectura de la información y la estructura de navegación de la plataforma, asegurando la inclusión de accesibilidad universal y un diseño ético que respeta la diversidad de usuarios.<br>**Eslander Celis Berrospi :**<br>Realizó un análisis ético en la creación de las user personas y las entrevistas de validación, priorizando la transparencia y la honestidad en el tratamiento de la información de los usuarios.<br>**Valentino Sandoval Paiva :**<br>Implementó las soluciones de autenticación y seguridad del sistema asegurando que las mejores prácticas en términos de privacidad y protección de datos fueran aplicadas.<br>**Diego Fernando Herrera Enriquez :**<br>Gestionó las entrevistas con usuarios y el análisis de competidores, enfocándose en un enfoque ético que asegurara la equidad y respeto en el diseño de la solución.<br> **TP:**<br>**Rodrigo Alya Cabrera**: Desarrolló la arquitectura de la información y la estructura de navegación de la plataforma, asegurando la inclusión de accesibilidad universal y un diseño ético que respeta la diversidad de usuarios.<br> **Eslander Celis Berrospi**: Realizó un análisis ético en la creación de las user personas y las entrevistas de validación, priorizando la transparencia y la honestidad en el tratamiento de la información de los usuarios.<br> **Valentino Sandoval Paiva**: Implementó las soluciones de autenticación y seguridad del sistema asegurando que las mejores prácticas en términos de privacidad y protección de datos fueran aplicadas.<br> **Diego Fernando Herrera Enriquez**: Gestionó las entrevistas con usuarios y el análisis de competidores, enfocándose en un enfoque ético que asegurara la equidad y respeto en el diseño de la solución. TB2: **Diego Fernando Herrera Enriquez**: Contribuí en la sección de Continuous Monitoring, definiendo prácticas que priorizan la transparencia y la confiabilidad del sistema mediante herramientas open source como Micrometer y Lighthouse. También diseñé las métricas de Data Analytics (KPIs y objetivos), asegurando que la recolección de datos fuera precisa. Además, realicé una entrevista de validación siguiendo principios de responsable de la información.<br> **TB2:**<br>**Rodrigo Alya Cabrera**: Implementó prácticas de DevOps basadas en la responsabilidad profesional, promoviendo la integridad en los procesos de integración y despliegue continuo, y asegurando que las configuraciones de entrega respetaran los estándares de calidad, seguridad y sostenibilidad técnica. <br> **Diego Fernando Herrera Enriquez**: Desarrolló las pruebas unitarias, de integración y de comportamiento del sistema con un enfoque ético en la validación del software, asegurando la transparencia, precisión y confiabilidad de los resultados para evitar sesgos o errores que afecten la experiencia del usuario. <br>**Valentino Sandoval Paiva :** <br> Desarrolló la documentación técnica y experimental del producto, aplicando buenas prácticas éticas en el diseño de experimentos y la gestión de métricas, priorizando la transparencia, la reproducibilidad de los resultados y el respeto a los principios de honestidad profesional en la investigación aplicada al software. <br > **Eslander Celis Berrospi**: <br> Lideró la verificación y auditoría de experiencias de usuario, aplicando principios éticos en la recolección y manejo de datos durante entrevistas y evaluaciones, garantizando la confidencialidad, el consentimiento informado y la imparcialidad en la interpretación de los resultados. <br> **TF**<br> **Rodrigo Alya Cabrera**<br> Demostré responsabilidad ética y profesional al desarrollar y optimizar la aplicación móvil, asegurando que todas las funcionalidades respetaran la privacidad del usuario, mantuvieran la integridad de los datos y cumplieran con buenas prácticas de ingeniería de software. <br> **Diego Fernando Herrera Enriquez** <br> Demostré responsabilidad ética y profesional al trabajar en la validación del backend, aplicando prácticas seguras y rigurosas para garantizar el correcto manejo de datos, la transparencia del sistema y la confiabilidad de los procesos internos. <br> **Valentino Sandoval Paiva** <br> Demostré responsabilidad ética y profesional al implementar las funcionalidades del frontend web, asegurando claridad en los cálculos, transparencia en la visualización de los montos y una experiencia segura que permita a los usuarios tomar decisiones informadas. <br> **Eslander Celis Berrospi** <br> Demostré responsabilidad ética y profesional al realizar auditorías de experiencia de usuario, evaluaciones heurísticas y revisiones de usabilidad, identificando problemas que podrían afectar la transparencia, la accesibilidad y la equidad dentro de la aplicación.  | **TB1**:<br> Durante todo el proceso, se priorizó la ética profesional mediante decisiones técnicas que fomentaron la accesibilidad, la seguridad y la privacidad del usuario.<br><br>Se reconoció la importancia de la transparencia y la responsabilidad en el manejo de datos personales, asegurando que las decisiones tomadas en todas las fases del proyecto fueran alineadas con principios éticos y responsables.<br>**TP1**:<br>  El equipo, en conjunto, priorizó la ética profesional en todas las fases del proyecto, asegurando que la plataforma fuera accesible, segura y respetuosa con la diversidad de usuarios. Las decisiones tomadas en cada etapa del desarrollo reflejaron un enfoque responsable y transparente, especialmente en lo relacionado con la protección de datos y la equidad. La colaboración fue clave para mantener estos principios a lo largo del proyecto.<br> **TB2** <br> El equipo demostró un compromiso sólido con la ética profesional en todas las etapas del desarrollo. Se priorizó la transparencia en la validación del producto, la protección de datos de los usuarios y la equidad en los procesos de auditoría y pruebas. Cada integrante asumió la responsabilidad de garantizar que las decisiones técnicas y metodológicas respetaran principios de honestidad, integridad y respeto hacia los usuarios, promoviendo un entorno de trabajo colaborativo y éticamente responsable. <br> **TF**<br> Durante el desarrollo del proyecto, el equipo demostró una sólida responsabilidad ética y profesional en cada decisión técnica y metodológica. Se priorizó la transparencia en el manejo de información, la protección de los datos de los usuarios y la implementación de prácticas seguras y confiables en todos los componentes del sistema. Cada integrante asumió un compromiso claro con el cumplimiento de estándares profesionales, adoptando soluciones que fomentaron la accesibilidad, la claridad y la integridad del producto final. La colaboración constante permitió mantener una cultura orientada a la ética profesional, garantizando que la plataforma operara de manera segura, honesta y responsable.                 |
| **4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales** | TB1: <br> **Rodrigo Alya Cabrera :**<br>Desarrolló el diseño asegurando que fuera inclusivo y accesible globalmente, teniendo en cuenta a diferentes grupos de usuarios y su impacto en diversas culturas.<br>**Eslander Celis Berrospi :**<br>Evaluó cómo las soluciones propuestas afectaban a diferentes contextos sociales, implementando cambios para que el producto fuera útil y accesible para un público global diverso.<br>**Valentino Sandoval Paiva :**<br>La implementación de medidas de seguridad y privacidad consideró el impacto económico, buscando una solución que fuera eficiente en términos de costo y fácil de mantener a largo plazo.<br>**Diego Fernando Herrera Enriquez :**<br>El análisis de competidores y entrevistas incluyó una evaluación del impacto social y económico del producto, para asegurar que la solución propuesta fuera viable en el contexto global.<br> TP1:<br> **Rodrigo Alya Cabrera** :  Desarrolló el diseño asegurando que fuera inclusivo y accesible globalmente, teniendo en cuenta a diferentes grupos de usuarios y su impacto en diversas culturas.<br> **Eslander Celis Berrospi** :Evaluó cómo las soluciones propuestas afectaban a diferentes contextos sociales, implementando cambios para que el producto fuera útil y accesible para un público global diverso.<br> **Valentino Sandoval Paiva** :La implementación de medidas de seguridad y privacidad consideró el impacto económico, buscando una solución que fuera eficiente en términos de costo y fácil de mantener a largo plazo.<br> **Diego Fernando Herrera Enriquez** : El análisis de competidores y entrevistas incluyó una evaluación del impacto social y económico del producto, para asegurar que la solución propuesta fuera viable en el contexto global.       <br> **TB2:**<br>**Rodrigo Alya Cabrera**: Tomó decisiones informadas en la implementación del pipeline de integración y despliegue continuo, considerando el impacto ambiental y económico de la infraestructura tecnológica empleada, promoviendo configuraciones más eficientes y sostenibles. <br> **Diego Fernando Herrera Enriquez**: Analizó los resultados de las pruebas del sistema evaluando su impacto en la eficiencia y sostenibilidad del producto, emitiendo juicios informados sobre la optimización de recursos y el mantenimiento responsable del software en contextos globales y económicos. <br>**Valentino Sandoval Paiva :** <br> Reflexionó sobre los resultados de los experimentos y métricas del producto, emitiendo juicios éticos y técnicos que valoraron el impacto social y global de las soluciones, promoviendo la innovación responsable y la mejora continua basada en datos verificables. <br > **Eslander Celis Berrospi**: <br> Evaluó las auditorías de experiencia de usuario considerando factores sociales y culturales, emitiendo juicios orientados a mejorar la accesibilidad, equidad y pertinencia del producto en distintos entornos y comunidades tecnológicas. <br> **TF**<br> **Rodrigo Alya Cabrera**<br> Demostré mi capacidad para emitir juicios informados al evaluar cómo las decisiones técnicas en el desarrollo móvil podían impactar a usuarios en distintos contextos globales, socioeconómicos y tecnológicos, priorizando soluciones accesibles, eficientes y sostenibles. <br> **Diego Fernando Herrera Enriquez** <br> Demostré juicio informado al analizar cómo las optimizaciones del backend influían en usuarios con distintos niveles de conectividad y recursos, priorizando una infraestructura que funcione de manera justa, rápida y estable en cualquier entorno. <br> **Valentino Sandoval Paiva** <br> Demostré juicio informado al considerar cómo la presentación de la información financiera podía afectar la colaboración entre los usuarios, diseñando interfaces que promuevan equidad, comprensión y un impacto positivo en las dinámicas económicas del grupo. <br> **Eslander Celis Berrospi** <br> Demostré juicio informado al analizar cómo las decisiones de diseño y accesibilidad impactan a usuarios con diferentes capacidades y contextos sociales, promoviendo una plataforma inclusiva que beneficie a una comunidad diversa.   | **TB1**: <br> Las decisiones tomadas en el desarrollo de la solución fueron guiadas por una visión global y económica, considerando tanto el bienestar social de los usuarios como la sostenibilidad y el impacto económico del proyecto.<br><br>El equipo también fue consciente de los posibles efectos ambientales y sociales, buscando crear una solución que tuviera un impacto positivo a largo plazo para los usuarios y la sociedad.<br> **TP**:<br> El equipo adoptó una perspectiva global y económica en todas las decisiones de diseño e implementación. Se evaluaron y consideraron los impactos sociales, culturales y económicos del producto, con un enfoque en crear una solución inclusiva, accesible y económicamente viable. La sostenibilidad y el impacto positivo en las comunidades globales fueron factores clave para orientar el desarrollo del proyecto, asegurando que las decisiones tomadas favorecieran tanto a los usuarios como al entorno económico y social.<br> **TB2**: <BR> El equipo adoptó una perspectiva integral y consciente sobre el impacto del software en diversos contextos. Se evaluaron los efectos económicos y ambientales de las soluciones implementadas, promoviendo prácticas sostenibles en la integración y despliegue continuo. Además, se consideraron factores sociales y culturales para asegurar que el producto fuera inclusivo, accesible y relevante a nivel global. Las decisiones se tomaron de manera informada, equilibrando la eficiencia técnica con la responsabilidad social y ambiental. <br> **TF**<br> A lo largo del proyecto, el equipo emitió juicios informados considerando cuidadosamente el impacto de cada solución en diversos contextos globales, sociales, económicos y tecnológicos. Se evaluaron las implicancias de las decisiones de diseño, desarrollo y validación, priorizando la accesibilidad, la eficiencia y la equidad para todo tipo de usuario, independientemente de su nivel económico o contexto digital. El equipo reflexionó sobre cómo la plataforma podría influir en la dinámica social de grupos reales, promoviendo prácticas de cooperación financiera justa y sostenible. Gracias a estas evaluaciones, se garantizó que el producto final no solo fuera técnicamente sólido, sino también responsable y consciente de su impacto en la sociedad.|
...
| **Fin del video** | 04:08 |
| **Link del video** | https://goo.su/SxaUdL |
...
| **Inicio del video** | 00:00 |
| **Fin del video** | 04:44 |
| **Link del video** | https://goo.su/MIazHVt |
...
| **Inicio del video** | 00:00 |
| **Fin del video** | 04:46 |
| **Link del video** | https://goo.su/pBWp |
...
| **User Story ID** | **Título**                                          | **Descripción**                                                                                                                                                                 | **Criterios de Aceptación**                                                                                                                                                                                                                                                                                                                                                                                                                        | **Relacionado con (Epic ID)** |
| ----------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| TS01              | Implementar autenticación JWT                       | Como desarrollador, quiero que el inicio de sesión implemente autenticación JWT para mayor seguridad en el manejo de sesiones.                                                  | **Escenario 1:** Generación del JWT<br>Dado que el usuario proporciona credenciales correctas, cuando se autentica, entonces el backend genera y responde con un JWT válido.<br>**Escenario 2:** Validación del JWT<br>Dado que el JWT se adjunta en el encabezado de la solicitud, cuando el backend verifica el token, entonces autoriza el acceso si el token es válido.                                                                        | EP02                          |
| TS02              | Cifrar contraseñas en base de datos                 | Como desarrollador, quiero que las contraseñas de los usuarios sean encriptadas antes de guardarlos en la base de datos para garantizar la seguridad.                           | **Escenario 1:** Almacenar contraseña cifrada<br>Dado que el password llega en texto plano, cuando el backend lo encripta, entonces se almacena en la base de datos de forma hashed.<br>**Escenario 2:** Validar contraseña cifrada durante autenticación<br>Dado que el password en base de datos está hashed, cuando el backend verifica credenciales, entonces primero hace el hash de la password ingresada y lo compara con el guardado.      | EP02                          |
| TS03              | Validar roles de administrador y miembro en backend | Como desarrollador, quiero que ciertos endpoints sean usados solo por determinados roles para asegurar que solo los usuarios autorizados puedan ejecutar determinadas acciones. | **Escenario 1:** Acceso permitido a endpoint por rol administrador<br>Dado que el rol incluido en el JWT es administrador, cuando invoque un endpoint administrador, entonces el backend permitirá el acceso.<br>**Escenario 2:** Acceso denegado a endpoint por rol no autorizado<br>Dado que el rol incluido en el JWT es miembro, cuando invoque un endpoint administrador, entonces el backend rechazará la solicitud con 403 (Forbidden).     | EP02                          |
| TS04              | Implementar actualización de perfil a partir de API | Como desarrollador, quiero implementar la actualización del perfil de usuario mediante una API para permitir que los usuarios modifiquen su información de manera segura.       | **Escenario 1:** Actualización exitosa<br>Dado que el token es válido, cuando el usuario envía nuevos datos, entonces el backend actualiza el perfil en la base de datos.<br>**Escenario 2:** Solicitud sin autenticación válida<br>Dado que el token es vencido o inexistente, cuando el backend recibe la solicitud, entonces responde con 401 (Unauthorized).                                                                                   | EP02                          |
| TS05              | Conectar formularios con endpoints                  | Como desarrollador, quiero conectar los formularios de registro y login con los endpoints del backend para que funcionen correctamente.                                         | **Escenario 1:** Envío de datos de registro al backend<br>Dado que el usuario complete el formulario de registro, cuando envía el formulario, entonces el formulario enviará la información al endpoint correspondiente.<br>**Escenario 2:** Autenticación de usuario mediante el backend<br>Dado que el usuario ingrese sus credenciales, cuando el frontend las envía al endpoint de autenticación, entonces el backend valida las credenciales. | EP02                          |
| TS06              | Validar respuestas del backend                      | Como desarrollador, quiero validar las respuestas del backend para mostrar mensajes adecuados al usuario.                                                                       | **Escenario 1:** Error en el registro<br>Dado que haya un error del backend al procesar el registro, cuando el usuario envíe un formulario, entonces se mostrará un mensaje de error específico.<br>**Escenario 2:** Fallo en el inicio de sesión<br>Dado que el backend retorne un 401 Unauthorized, cuando se intente iniciar sesión, entonces el front indicará que las credenciales son inválidas.                                             | EP02                          |
| TS07              | Implementar actualización y eliminación de gastos   | Como desarrollador, quiero poder actualizar o eliminar gastos.                                                                                                                  | **Escenario 1:** Actualización<br>Dado que el gasto existe, cuando el administrador envía nuevos datos, entonces el backend actualiza el registro.<br>**Escenario 2:** Eliminado<br>Dado que el administrador solicita borrar, cuando el backend elimina el gasto, entonces deja de aparecer en futuros reportes.                                                                                                                                  | EP04                          |
| TS8              | Verificar integración de gastos                     | Como desarrollador, quiero verificar que el backend de gastos esté correctamente conectado al frontend.                                                                         | **Escenario 1:** Mostrar lista de gastos<br>Dado que haya gastos registrados, cuando el usuario acceda a la sección de gastos, entonces se mostrará la información proveniente del backend.<br>**Escenario 2:** Agregar gasto<br>Dado que se complete el formulario, cuando se presione "Guardar", entonces se guardará mediante la API y se actualizará la vista.                                                                                 | EP04                          |
...
| 25     | TS02          | Cifrar contraseñas en base de datos                    | Implementar cifrado de contraseñas                                      | 5            |
| 26     | TS03          | Validar roles de administrador y miembro en backend    | Verificar que los roles estén definidos y sean accesibles               | 4            |
| 29     | TS06          | Validar respuestas del backend en la gestión de perfil | Asegurar que el backend maneje correctamente la actualización de perfil | 3            |
...
Como parte del proceso de evaluación cruzada, nuestro proyecto SplitEasy fue auditado por el equipo "EduSpace", quienes nos proporcionaron valiosos insights sobre nuestra experiencia de usuario.
...
| :--------: | :---------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 11/11/2025 | **Presentación del proyecto**                   | Reunión inicial en la que el equipo auditor explicó su enfoque de trabajo y definió los objetivos junto con el alcance de la evaluación del proyecto *SplitEasy*.                   |
...
### Hallazgos de la Auditoría Recibida

El equipo auditor realizó una evaluación exhaustiva de nuestras interfaces y flujos de usuario del **“Representante del hogar”**, identificando los siguientes hallazgos:


####  Hallazgos Críticos (Severidad 4)

* **Visualización limitada en la sección “Facturas del Hogar”**
  Se identificó que la visualización de los registros es limitada, ya que solo presenta una tabla básica sin herramientas de búsqueda o filtrado. Esto puede dificultar la gestión eficiente de las facturas cuando el número de registros aumente.
...
* **Captcha con validación incorrecta**
  ...
  **Recomendación:** Revisar la integración del captcha y asegurar que su validación sea obligatoria antes de permitir cualquier acción del usuario.


####  Hallazgos Mayores (Severidad 3)

* **Configuración manual de datos de pago en contribuciones**
  ...
  **Recomendación:** Asignar a cada perfil su propio código QR y número de cuenta predeterminado, vinculados directamente a su información de pago. Así, el sistema podría autocompletar los datos al generar una nueva contribución.

* **Falta de acceso rápido a contribuciones próximas a vencer**
  En la vista del miembro dentro del inicio, se observa que las contribuciones próximas a vencer se muestran de manera estática, sin ofrecer un acceso directo a su pago o gestión, generando una experiencia menos práctica.
  **Recomendación:** En la sección *Inicio*, añadir en cada contribución próxima a vencer un botón de acción rápida (por ejemplo, **“Pagar ahora”** o **“Ir a contribuciones”**) que redirija directamente al flujo de pago correspondiente.


####  Aspectos Positivos Destacados

* **Explicación clara y contextual al crear contribuciones**
  La interfaz presenta una explicación clara del funcionamiento del tipo de comportamiento al crear una contribución, detallando la lógica de reparto proporcional y acompañándola con un ejemplo práctico.

* **Integración del chatbot con inteligencia artificial**
  Mejora la interacción entre el usuario y la aplicación, ofreciendo asistencia inmediata, respuestas personalizadas y una guía fluida durante todo el proceso. Esto contribuye a una experiencia más intuitiva y eficiente.

* **Automatización de pagos mediante códigos QR**
  La incorporación de códigos QR agiliza las transacciones y minimiza los errores, permitiendo que los usuarios realicen aportes de manera rápida y segura. Esta funcionalidad moderniza la plataforma y optimiza los tiempos de gestión.

* **Navegación intuitiva**
  El menú lateral es consistente y jerárquico, permitiendo un fácil acceso a las funciones principales: *Inicio*, *Miembros*, *Cuentas*, *Contribuciones* y *Ajustes*.
...
- **Optimización de la sección “Facturas del Hogar”**  
  Se añadió la funcionalidad de búsqueda, filtrado y ordenamiento dentro de la tabla de facturas, permitiendo al usuario organizar los registros por fecha, monto o tipo de servicio. Además, se incorporaron etiquetas visuales que indican el estado de cada factura (*pagada*, *pendiente* o *vencida*), mejorando la claridad y el control de los pagos.

- **Corrección del sistema de captcha**  
  Se revisó la configuración de validación y se implementó un captcha funcional con verificación obligatoria, garantizando que el acceso solo sea permitido tras una validación exitosa.  
  **Impacto:** Aumento de la seguridad y reducción del riesgo de accesos automatizados.

- **Automatización de los datos de pago**  
  Cada usuario ahora cuenta con un código QR y número de cuenta preasignado, que se autocompleta al generar nuevas contribuciones. Esto elimina la necesidad de ingresar manualmente la información en cada registro, optimizando el proceso de pago.

- **Incorporación de accesos rápidos en el inicio**  
  Se añadió un botón de acción directa **“Pagar ahora”** en las contribuciones próximas a vencer dentro del panel de inicio, permitiendo que el usuario acceda rápidamente al flujo de pago sin navegar por múltiples secciones.

Estas mejoras fueron implementadas en un **sprint dedicado de varias semanas**, priorizando los problemas críticos identificados en la auditoría.
